var MassUpdateFunctions = {
	...
	firstStep: function () {
		var thisMassUpdate = JSON.parse(sessionStorage.getItem('thisMassUpdate'));
		if (thisMassUpdate == 0) {
			var newMassUpdateId = Math.floor((Math.random() * 1000000000000000));
			...
			$('.newMassUpdateId').text(newMassUpdateId);
	...
	selectProgramTabs: function () {
		$('.panelWithTabs li').off("click");
		$('.panelWithTabs li').on("click", function () {
	...
	selectAndMoveToOverview: function () {
