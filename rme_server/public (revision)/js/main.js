...
var tableBehavior = {
	...
	customerTableLink: function () {
		$('.customerTable').on("click", '.id', function () {
			window.location.href = 'customer-read-only.html';
		});
	}
};
...
var clickNav = {
	...
	contracts: function () {
		$('.subsection .search-btn, .contracts').on("click", function () {
			window.location.href = 'contract-search.html';
		});
	},
	home: function () {
	...
	edit: function  () {
		$('.edit').on("click", function () {
			if ( window.location.href.match('contract-read-only.html') ) {
				window.location.href = 'contract-input.html';
			}
			else {
				window.location.href = 'customer-input.html';
			}
		});
	},
	read: function  () {
...
MassUpdateFunctions.selectProgramTabs();
MassUpdateFunctions.selectAndMoveToOverview();
