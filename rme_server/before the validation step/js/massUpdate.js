...
var tableBehavior = {
	...
	contractTableLink: function () {
		$('.contractTable').on("click", '.id', function () {
			window.location.href = 'http://hdqpdweb1.modeln.com/nimbus/rme/contract-read-only.html';
		});
	},

	customerTableLink: function () {
		$('.customerTable').on("click", '.id', function () {
			window.location.href = 'http://hdqpdweb1.modeln.com/nimbus/rme/customer-read-only.html';
		});
	}
};
...
var clickNav = {
	...
	contracts: function () {
		$('.subsection .search-btn, .contracts').on("click", function () {
			window.location.href = 'http://hdqpdweb1.modeln.com/nimbus/rme/contract-search.html';
		});
	},
	home: function () {
		$('.home, .alerts').on("click", function () {
			window.location.href = 'http://hdqpdweb1.modeln.com/nimbus/rme/home.html';
		});		
	},
	customers: function () {
		$('.customers').on("click", function () {
			window.location.href = 'http://hdqpdweb1.modeln.com/nimbus/rme/customer-search.html';
		});
	},
	edit: function  () {
		$('.edit').on("click", function () {
			if ( window.location.href.match('contract-read-only.html') ) {
				window.location.href = 'http://hdqpdweb1.modeln.com/nimbus/rme/contract-input.html';
			}
			else {
				window.location.href = 'http://hdqpdweb1.modeln.com/nimbus/rme/customer-input.html';
			}
		});
	},
	read: function  () {
...
MassUpdateFunctions.formFunctions.slider();
MassUpdateFunctions.formFunctions.filterSlider();
MassUpdateFunctions.formFunctions.stateSelect();
MassUpdateFunctions.formFunctions.typeSelect();
MassUpdateFunctions.programFilterFunctions.filterStates();
MassUpdateFunctions.programFilterFunctions.selectState();
MassUpdateFunctions.programFilterFunctions.selectType();
MassUpdateFunctions.programFilterFunctions.selectProgramsFromFilter();
MassUpdateFunctions.programFilterFunctions.makeSelection();
