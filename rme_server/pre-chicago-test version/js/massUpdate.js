...
var tableBehavior = {
	...
	contractTableLink: function () {
		$('.contractTable').on("click", '.id', function () {
			window.location.href = 'http://localhost:3000/contract-read-only.html';
		});
	},

	customerTableLink: function () {
		$('.customerTable').on("click", '.id', function () {
			window.location.href = 'http://localhost:3000/customer-read-only.html';
		});
	}
};
...
var clickNav = {
	...
	contracts: function () {
		$('.subsection .search-btn, .contracts').on("click", function () {
			window.location.href = 'http://localhost:3000/contract-search.html';
		});
	},
	home: function () {
	...
	customers: function () {
		$('.customers').on("click", function () {
			window.location.href = 'http://localhost:3000/customer-search.html';
		});
	},
	edit: function  () {
		$('.edit').on("click", function () {
			if ( window.location.href.match('contract-read-only.html') ) {
				window.location.href = 'http://localhost:3000/contract-input.html';
			}
			else {
				window.location.href = 'http://localhost:3000/customer-input.html';
			}
		});
	},
	read: function  () {
...
MassUpdateFunctions.approveMassUpdate();
